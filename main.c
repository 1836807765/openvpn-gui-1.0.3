...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
  ...
  switch (message) {
    ...
    case WM_DESTROY:
    	//MessageBox(NULL, "destory", "2", MB_OK);
    	//modify_ie_proxy_setting_while_connected();//test need del
...
BOOL CALLBACK AboutDialogFunc (HWND hwndDlg, UINT msg, WPARAM wParam, UNUSED LPARAM lParam)
{
  ...
  switch (msg) {
    ...
    case WM_INITDIALOG:
      ...
      //del by mey 20130905 删除关于对话框的赋值
      //SetDlgItemText(hwndDlg, ID_TEXT_OPENVPNGUI, buf2);
      //del by mey 20130905 end
