...
{
  char filename[200] = "Config.exe";
  char exename[200] = "Config.exe";
  ...
  //del by mey by test 20130901
  //mysnprintf(filename, "%s \"%s\\%s\"", o.editor, o.cnn[config].config_dir, o.cnn[config].config_file);
	mysnprintf(filename, "%s -dir %s\\%s", exename, o.cnn[config].config_dir, o.cnn[config].config_file);
  //filename = "C:\\Program Files\\OpenVPN\\bin\\Config.exe";
